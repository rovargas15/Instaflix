...
class TvRepositoryImpl @Inject constructor(
    ...
    override suspend fun getTvById(id: Int): Flow<Tv> =
        db.tvDao().getTvById(id).map { resultsChange -> resultsChange.toDomain() }

    override suspend fun getTvDetailById(id: Int): Result<TvDetail> = launchResultSafe {
        dataSourceRemote.getTvById(id).toDomain()
    }

    override suspend fun getSearchTv(query: String): Result<DataBase<Tv>> = launchResultSafe {
    ...
    override suspend fun getPaginatedTv(
        ...
        pageSize: Int,
        page: Int,
    ): Result<DataBase<Tv>> = launchResultSafe {
