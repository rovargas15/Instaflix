...
data class TvDetailResponse(
    ...
    data class CreatedBy(
        ...
        fun toDomain() = com.instaleap.domain.model.TvDetail.CreatedBy(
            creditId = creditId, gender = gender, id = id, name = name, originalName = originalName
        )
    }
    ...
    data class LastEpisodeToAir(
        ...
        fun toDomain() = com.instaleap.domain.model.TvDetail.LastEpisodeToAir(
            airDate = airDate,
    ...
    data class Network(
        ...
        fun toDomain() = com.instaleap.domain.model.TvDetail.Network(
    ...
    data class NextEpisodeToAir(
        ...
        fun toDomain() = com.instaleap.domain.model.TvDetail.NextEpisodeToAir(
            airDate = airDate,
            episodeNumber = episodeNumber,
            episodeType = episodeType,
            id = id,
    ...
    data class Season(
        ...
        fun toDomain() = com.instaleap.domain.model.TvDetail.Season(
            airDate = airDate,
