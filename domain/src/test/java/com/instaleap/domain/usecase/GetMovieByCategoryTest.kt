...
class GetMovieByCategoryTest {
    private val repository: MovieRepository = mockk()
    private val getMovieByCategory = GetMovieByCategory(repository)
    ...
    fun `Give category and page When invoke Then return result movie`() =
        runBlocking {
            ...
            // When
            val result = getMovieByCategory.invoke("movie", 2)
    ...
    fun `Give category  When invoke Then return result movie`() =
        runBlocking {
            ...
            // When
            val result = getMovieByCategory.invoke("movie")
